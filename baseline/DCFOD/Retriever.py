...
def fetch(temp_score, labels, sensitive_attribute_group):
    """
    fetch the fairness metrics Fgap and Frank for a dataset with the obtained score

    Args:
        temp_score: outlier score
        label_path: the true outlier labels
        sensitive_attribute_group: the sensitive attribute subgroup information
